---
name: session-reader
description: Read and analyze Claude Code session logs from ~/.claude/projects/. Use when retrieving what happened in a previous browsing session — failures, tool calls, decisions, patterns — to inform the current browser task or skill generation.
